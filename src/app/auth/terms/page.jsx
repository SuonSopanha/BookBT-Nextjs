            ...
            <div class="w-full py-16 px-12">
              ...
              <ol class="list-decimal list-inside mt-4 text-gray-700 text-sm">
                <li class="mb-2">
                  ...
                  and Agreement. The terms may be updated from time to time, and
                ...
                <li class="mb-2">
                  ...
                  platform allows users to book rides or bus services
                ...
                <li class="mb-2">
                  ...
                  information. You are responsible for all charges incurred
                  through your account. Taxi/Bus Booking Website may use
                  third-party payment processors to handle transactions, and
                ...
                <li class="mb-2">
                  ...
                  privacy. By using the Service, you agree to the terms outlined
                ...
                <li class="mb-2">
                  ...
                  service. Please be specific and constructive in your comments,
                  highlighting positive experiences and suggesting areas for
                  improvement. The rating system should be used responsibly to
                ...
                <li class="mb-2">
                  ...
                  prohibited from reproducing, distributing, or creating
                ...
                <li class="mb-2">
                  ...
                  on the website. Your continued use of the Service after such
