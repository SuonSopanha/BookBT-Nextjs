        ...
        <div class="mx-auto flex flex-col justify-center space-y-4 p-4 md:flex-row md:space-x-5 md:space-y-0">
          ...
          <div class="relative w-full sm:w-1/2 rounded-lg bg-white">
            <div class="m-4 pb-12">
              ...
              <table id="Booking" class=" bg-white w-full table-fixed text-sm shadow-md rounded-lg overflow-hidden">
                <colgroup>
                  <col style={{width: '20%'}} /> 
                  <col style={{width: '20%'}} /> 
                  <col style={{width: '20%'}} /> 
                ...
                <thead class="text-left" id="table-header">
                  <tr class="text-slate-700">
                    <th class="p-3 cursor-pointer bg-blue-900 text-white"
                      onclick="toggleTableVisibility('Scheduled', this)">Scheduled</th>
                    <th class="p-3 cursor-pointer " onclick="toggleTableVisibility('Route', this)">Route</th>
                    <th class="p-3 cursor-pointer " onclick="toggleTableVisibility('Vehicles', this)">Vehicles</th>
                    <th class="p-3 cursor-pointer " onclick="toggleTableVisibility('Price', this)">Price</th>
                    <th class="p-3 cursor-pointer " onclick="toggleTableVisibility('BookingTB', this)">Booking</th>
                  </tr>
                </thead>
                ...
                <tbody class="divide-y divide-gray-200 active" id="Scheduled">
                  <tr class="bg-blue-900 text-white ">
                    <th class="p-3">ID</th>
                    <th class="p-3" colspan="2">Flee</th>
                    <th class="p-3" colspan="2">Arrive</th>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">1</td>
                    <td class="p-3" colspan="2">Phnom Penh</td>
                    <td class="p-3" colspan="2">Siem Reap</td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">2</td>
                    <td class="p-3" colspan="2">Phnom Penh</td>
                    <td class="p-3" colspan="2">Svay Rieng</td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">3</td>
                    <td class="p-3" colspan="2">Phnom Penh</td>
                    <td class="p-3" colspan="2">Khos kong</td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">4</td>
                    <td class="p-3" colspan="2">Phnom Penh</td>
                    <td class="p-3" colspan="2">Prey Verng</td>
                  </tr>
                </tbody>

                <tbody class=" divide-y divide-gray-200  hidden" id="BookingTB">
                  <tr class="bg-blue-900 text-white font-medium text-center">
                    <td class="p-3">Username</td>
                    <td class="p-3">Time</td>
                    <td class="p-3" colspan="2">Direction</td>
                    <td class="p-3">Request</td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3"><a class="underline text-blue-600 bold" href="bookingRequest.html">Kola</a></td>
                    <td class="p-3">Jan - 10 Mon 08:00 AM</td>
                    <td class="p-3" colspan="2">Svay Rieng - Phnom Penh</td>
                    <td class="p-3 font-bold "><button class="text-red-600 mr-6">Decline</button><button
                        class="text-green-600">Accept</button></td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3"><a class="underline text-blue-600 bold" href="bookingRequest.html">Kola</a></td>
                    <td class="p-3">Jan - 10 Mon 08:00 AM</td>
                ...
                <tbody class=" divide-y divide-gray-200 hidden" id="Route">
                  <tr class="bg-blue-900 text-white">
                    ...
                    <th class="p-3" colspan="2">Location</th>
                    <th class="p-3" colspan="2">Direction</th>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">08:00 AM</td>
                    <td class="p-3" colspan="2">Pnom Penh</td>
                    <td class="p-3" colspan="2">Svay Rieng</td>
                  </tr>
                  <tr class="text-center">
                  ...
                  <tr class="text-center">
                    <td class="p-3">08:00 AM</td>
                    <td class="p-3" colspan="2">Svay Rieng</td>
                    <td class="p-3" colspan="2">Bavet</td>
                  </tr>
                </tbody>
                ...
                <tbody class=" divide-y divide-gray-200 hidden" id="Vehicles">
                  ...
                  <tr class="bg-blue-900 text-white">
                    ...
                    <th class="p-3" colspan="1">Seat</th>
                    <th class="p-3" colspan="1">Type</th>
                  </tr>
                  <tr>
                ...
                <tbody class=" divide-y divide-gray-200 hidden" id="Price">
                  <tr class="bg-blue-900 text-white">
                    <th class="p-3">Time</th>
                    <th class="p-3" colspan="2">Direction</th>
                    <th class="p-3" colspan="2">Price</th>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">08:00 AM</td>
                    <td class="p-3" colspan="2">Svay Rieng</td>
                    <td class="p-3" colspan="2">$6</td>
                  </tr>
                  <tr class="text-center">
                    <td class="p-3">08:00 AM</td>
                    <td class="p-3" colspan="2">Svay Rieng</td>
