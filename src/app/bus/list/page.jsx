        ...
        <>
          ...
          <div class="relative">
            <div class="relative bg-white pt-2">
              ...
              <div class="-mt-32 flex h-32 w-full flex-col items-center justify-end bg-gradient-to-tr from-yellow-300 to-yellow-100 p-12">
                <div class="flex flex-col items-center space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                  <div class="relative flex-shrink-0">
                    <input
                      type="text"
                      placeholder="Search Bus"
                      class="block h-14 w-full rounded-lg px-4 py-3 text-lg font-medium text-black md:w-96"
                    />
                    <button
                      type="button"
                      class="absolute inset-y-0 right-1 flex-shrink-0 items-center justify-center gap-x-1 bg-transparent p-2 font-semibold text-white"
                    >
                      <img
                  ...
                  <div class="h-14 items-center justify-center rounded-md bg-white p-2 text-center md:w-44">
                    <div class="flex justify-center">
                      <img
                        ...
                        alt="calendar--v1"
                      />
                      <p class="ml-2 font-medium text-zinc-600">Pick-up date</p>
                    </div>
                    <p class="text-xs font-medium">Sun, 10 Dec</p>
                  </div>
                  ...
                  <div class="h-14 items-center justify-center rounded-md bg-white p-2 text-center md:w-44">
                    <div class="flex items-center justify-center">
                      <img
                        ...
                        alt="clock--v1"
                      />
                      <p class="ml-2 font-medium text-zinc-600">Time</p>
                    </div>
                    <p class="text-xs font-medium">10:00 AM</p>
                  </div>
    
                  <a href="#">
                    <div class="flex h-14 w-full items-center justify-center rounded-lg bg-blue-800 p-2 font-medium text-white md:w-24">
                      <p>Search</p>
                    </div>
                  </a>
                </div>
              ...
              <div class="bg-white p-5">
                <div class="text-center text-4xl font-medium">
                  <p class="inline border-b-4 border-yellow-500">Taxi Services</p>
            ...
            <div class="relative bg-white pt-2">
              <div class="flex h-full items-center justify-center bg-white p-10">
                <div class="border-t-2 border-yellow-500">
                  <div class="md:max-w-fixed flex flex-col items-center rounded-lg md:flex-row dark:bg-white">
                    <img
                      class="h-full w-full object-cover md:h-auto md:w-96 md:rounded-none"
                      ...
                      alt=""
                    />
                    <div class="ml-10 mt-4 flex h-full w-full flex-col justify-start">
                      <div class="flex h-full items-start justify-center">
                        <div class="items-left flex flex-col text-left">
                          <img
                            width="50"
                            height="50"
                            ...
                            alt="calendar--v1"
                          />
                          <p class="text-center text-2xl font-medium">08</p>
                          <p class="font-medium">March</p>
                        </div>
                        <div class="ml-10 items-center">
                          <p class="whitespace-nowrap text-xl font-bold">
                            PORFOLIO & CONTACT
                          </p>
                          <div class="mt-2 flex items-center">
                            <img
                              ...
                              alt="facebook-new"
                            />
                            <p class="ml-2 font-medium">KAKA Jr</p>
                          </div>
                          <div class="mt-2 flex items-center">
                            <img
                              width="24"
                              ...
                              alt="phone--v1"
                            />
                            <p class="ml-2 font-medium">097 777 8888</p>
                          </div>
                          <div class="mb-4 mt-2 flex items-center">
                            <img
                              ...
                              alt="clock--v1"
                            />
                            <p class="ml-2 font-medium">10 AM</p>
                            <div class="ml-4 mt-5 flex">
                              <img
                                width="48"
                                height="48"
                        ...
                        <a href="compareTaxi.html" class="ml-10">
                          <img
                            width="30"
                            height="30"
              ...
              >
                <ul class="inline-flex -space-x-px text-sm">
                  <li>
                    <a
                      href="#"
                      class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-yellow-700 bg-yellow-200 border border-e-0 border-yellow-300 rounded-s-lg hover:bg-yellow-100 hover:text-yellow-600 dark:bg-yellow-200 dark:border-yellow-700 dark:text-yellow-400 dark:hover:bg-yellow-500 dark:hover:text-white"
                    >
                      Previous
                    </a>
                  </li>
                  <li>
                    <a
                      href="#"
                      class="flex items-center justify-center px-3 h-8 leading-tight text-yellow-700 bg-yellow-200 border border-yellow-300 hover:bg-yellow-100 hover:text-yellow-600 dark:bg-yellow-200 dark:border-yellow-700 dark:text-yellow-400 dark:hover:bg-yellow-500 dark:hover:text-white"
                    >
                      1
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      href="#"
                      aria-current="page"
                      class="flex items-center justify-center px-3 h-8 text-blue-600 border border-yellow-300 bg-yellow-200 hover:bg-yellow-100 hover:text-yellow-600 dark:border-yellow-700 dark:bg-yellow-500 dark:text-white"
                    >
                      3
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      href="#"
                      class="flex items-center justify-center px-3 h-8 leading-tight text-yellow-700 bg-yellow-200 border border-yellow-300 rounded-e-lg hover:bg-yellow-100 hover:text-yellow-600 dark:bg-yellow-200 dark:border-yellow-700 dark:text-yellow-400 dark:hover:bg-yellow-500 dark:hover:text-white"
                    >
                      Next
                    </a>
                  </li>
